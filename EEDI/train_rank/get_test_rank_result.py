...
if __name__ == '__main__':
    ...
    dev_df = pd.read_parquet(f"file/valid_recall_100.parquet")
    dev_df=dev_df[:5]
    print(dev_df.shape)
    ...
    # dev_df['query_and_body'] = dev_df['query_text'] 
    ...
    for _, df in predict_list.groupby("order_id"):
        ...
        predicts_test.append([candi_ids[index] for index in score_indexs[:40]])

    f = open(f"rank_result/{model_name}_rank_{TOP_NUM}.txt", 'w')
